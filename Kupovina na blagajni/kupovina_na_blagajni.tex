\subsection{Slučaj upotrebe: Kupovina na blagajni}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Kupovina na blagajni/dijagram_aktivnosti_kupovina_na_blagajni.jpg}
    \caption{Dijagram aktivnosti: Kupovina na blagajni}
    \label{fig:dijagram_aktivnosti_kupovina_na_blagajni}
\end{figure}

\subsubsection*{Dijagram sekvenci}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Kupovina na blagajni/dijagram_sekvence_kupovina_na_blagajni.jpg}
