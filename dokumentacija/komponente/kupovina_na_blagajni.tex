...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../dijagrami/aktivnosti/dijagram_aktivnosti_kupovina_na_blagajni.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../dijagrami/sekvence/dijagram_sekvence_kupovina_na_blagajni.jpg}
