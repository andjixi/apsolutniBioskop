...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.2\textwidth]{../dijagrami/aktivnosti/dodavanje_novih_zaposlenih_dijagaram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.2\textwidth]{../dijagrami/sekvence/dodavanje_novih_zaposlenih_dijagram_sekvence.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.2\textwidth]{../dijagrami/bpmn/dodavanje_zaposlenog_bpmn_saradnje.jpg}
}
