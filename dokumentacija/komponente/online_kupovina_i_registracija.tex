...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../dijagrami/aktivnosti/dijagram_aktivnosti_online_kupovina.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../dijagrami/sekvence/dijagram_sekvence_online_kupovina.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../dijagrami/stanja/dijagram_stanja_sedista.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../dijagrami/bpmn/bpmn_dijagram_procesa_online_kupovina.jpg}
