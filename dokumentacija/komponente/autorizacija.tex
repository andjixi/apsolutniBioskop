...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.2\textwidth]{../dijagrami/aktivnosti/autorizacija_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.2\textwidth]{../dijagrami/sekvence/autorizacija_dijagram_sekvence.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1\textwidth]{../dijagrami/stanja/dijagram_stanja_naloga_autorizacija.jpg}
}
