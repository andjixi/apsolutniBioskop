...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=0.73\textwidth]{Izmena Repertoara/izmena_repertoara_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.3\textwidth]{Izmena Repertoara/izmena_repertoara_bpmn_dijagram.jpg}
}
