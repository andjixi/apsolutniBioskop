...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=0.74\textwidth]{Izmena Repertoara/izmena_repertoara_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.2\textwidth]{Izmena Repertoara/izmena_repertoara_upravljanje_filmovima_dijagram_sekvence.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1\textwidth]{Izmena Repertoara/izmena_repertoara_dijagram_sekvence.jpg}
}
...
\newpage
\subsection*{BPMN dijagram}
\begin{figure}[h!]
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.4\textwidth]{Izmena Repertoara/izmena_repertoara_bpmn_dijagram.jpg}
}
