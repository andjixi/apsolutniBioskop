...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=0.74\textwidth]{izmena_repertoara_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.2\textwidth]{izmena_repertoara_upravljanje_filmovima_dijagram_sekvence.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1\textwidth]{izmena_repertoara_dijagram_sekvence.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.4\textwidth]{izmena_repertoara_bpmn_dijagram.jpg}
}
