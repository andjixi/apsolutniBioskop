...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.5\textwidth]{upravljanje_podacima_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.5\textwidth]{upravljanje_podacima_dijagram_sekvence.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1\textwidth]{dijagram_stanja_filma.jpg}
}
