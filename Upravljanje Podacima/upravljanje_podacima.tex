...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.3\textwidth]{Upravljanje Podacima/upravljanje_podacima_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.2\textwidth]{Upravljanje Podacima/upravljanje_podacima_dijagram_sekvence.jpg}
}
