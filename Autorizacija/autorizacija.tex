...
\section*{Slučaj upotrebe: Autorizacija}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.5\textwidth]{autorizacija_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.5\textwidth]{autorizacija_dijagram_sekvence.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1\textwidth]{dijagram_stanja_naloga.jpg}
}
