...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.5\textwidth]{Autorizacija/autorizacija_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.5\textwidth]{Autorizacija/autorizacija_dijagram_sekvence.jpg}
}
