...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Sistem je povezan sa bazom podataka o projekcijama, cenama i raspoloživim sedištima.
    \end{itemize}
    \vspace{5pt}
    ...
    \begin{enumerate}
        ...
        \item Sistem prikazuje konačnu cenu i opcije plaćanja.
        \item Korisnik bira način plaćanja i unosi potrebne podatke
    ...
    \begin{enumerate}
        ...
        \item Sistem ažurira raspoloživost sedišta u bazi podataka.
        \item Sistem šalje potvrdu o rezervaciji korisniku putem e-pošte i prikazuje na 
    \end{enumerate}
    \vspace{5pt}
