...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{Online kupovina i rezervacija/dijagram_aktivnosti_online_kupovina.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{Online kupovina i rezervacija/dijagram_stanja_sedista.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{Online kupovina i rezervacija/bpmn_dijagram_procesa_online_kupovina.jpg}
