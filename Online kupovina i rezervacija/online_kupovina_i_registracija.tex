...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{dijagram_aktivnosti_online_kupovina.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{dijagram_sekvence_online_kupovina.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{dijagram_stanja_sedista.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{bpmn_dijagram_procesa_online_kupovina.jpg}
