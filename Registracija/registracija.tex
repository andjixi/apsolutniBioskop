\section*{Slučaj upotrebe: Registracija}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.5\textwidth]{Registracija/registracija_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.5\textwidth]{Registracija/registracija_dijagram_sekvence.jpg}
}
...
\newpage
\subsection*{Dijagram stanja Naloga}

\begin{figure}[h!]
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=0.7\textwidth]{Registracija/dijagram_stanja_naloga.jpg}
}
