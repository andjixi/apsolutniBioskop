...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.5\textwidth]{registracija_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.5\textwidth]{registracija_dijagram_sekvence.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=0.7\textwidth]{dijagram_stanja_nalog.jpg}
}
