...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.2\textwidth]{Registracija/registracija_dijagram_aktivnosti.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=1.2\textwidth]{Registracija/registracija_dijagram_sekvence.jpg}
}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=0.5\textwidth]{Registracija/dijagram_stanja_naloga.jpg}
}
